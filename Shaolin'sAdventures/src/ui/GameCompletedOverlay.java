 ...
 *
 */
public class GameCompletedOverlay extends State implements StateMethods{
	
	private BufferedImage[] gameCompleted;
	...
	private void loadOverlay() {
		this.gameCompleted = new BufferedImage[2];
		this.gameCompleted[0] = LoadSave.getImage("/overlays/gamecompleted1.png");
		this.gameCompleted[1] = LoadSave.getImage("/overlays/gamecompleted2.png");
	...
	public void draw(Graphics2D g) {
		...
		g.drawImage(gameCompleted[imgIndex], xPosition, yPosition, width, height, null);
		homeButton.draw(g);
	}
