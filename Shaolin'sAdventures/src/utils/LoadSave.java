...
public class LoadSave {
	...
	public static BufferedImage[] getButtonsImages(String[] imgPath) {
		
		BufferedImage[] img = new BufferedImage[imgPath.length];
		int counter = 0;
	...
	//extracting map tiles data from text matrix with number references to the different tiles
